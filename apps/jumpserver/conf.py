...
class Config(dict):
    ...
    defaults = {
        ...
        'ANSIBLE_DOCKER_ENABLED': False,  # Yetka: EE ansible runner imajı yok; job'lar lokal çalışır
        ...
        # 导航栏 帮助
        'HELP_DOCUMENT_URL': 'https://github.com/akinarcak/Yetka',
        'HELP_SUPPORT_URL': 'https://github.com/akinarcak/Yetka/issues',
