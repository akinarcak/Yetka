...
install_management_tools() {
  ...
  run install -o root -g root -m 0750 "$YETKA_INSTALL_DIR/app/deploy/yetka-update-plan-runner.sh" /usr/local/sbin/yetka-update-plan-runner
